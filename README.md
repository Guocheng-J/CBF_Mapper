# CBF_Mapper
The script analyses pcASL MRI data to derive cerebral blood flow maps. The script is designed to work on both Siemens and GE pcASL sequences (single-PLD and multiple-PLD).
...
A video recording is available from a tutorial lecture delivered by Guocheng. Please cite the video and this data repository when you repost the video.
